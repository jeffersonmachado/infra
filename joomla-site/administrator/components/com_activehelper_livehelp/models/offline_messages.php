...
class activehelper_livehelpModeloffline_messages extends JModelList
	...
	protected function populateState($ordering = NULL, $direction = NULL)
	{
       ...
       /**
        ...
        protected function getListQuery()
        {
          ...
          $query= "Select jlom.id, jlom.name , jlom.email, jld.name domain, jlom.phone, jlom.company, jlom.datetime , jlom.message , jlom.answered   ".
                  " From   #__livehelp_offline_messages jlom , #__livehelp_domains jld ".
                  " WHERE DATE_FORMAT(jlom.datetime,'%Y%m%d') >=DATE_FORMAT(". "'" .$this->_search_start. "'" . ",'%Y%m%d')".
                  " and DATE_FORMAT(jlom.datetime,'%Y%m%d') <=DATE_FORMAT( ". "'" .$this->_search_end. "'" . ",'%Y%m%d')".
