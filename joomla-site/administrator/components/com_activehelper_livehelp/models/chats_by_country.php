...
class activehelper_livehelpModelChats_by_country extends JModelList
{
     ...
     protected function populateState($ordering = NULL, $direction = NULL)
       ...
       /**
        ...
        protected function getListQuery()
        {
          ...
          $query= "select jlr.country , count(*) chats , avg(jls.rating) rating ".
                  " from  #__livehelp_sessions jls , #__livehelp_requests jlr ".
