...
class activehelper_livehelpModelChats_by_dept extends JModelList
{
		...
		protected function populateState($ordering = NULL, $direction = NULL)
	{
       ...
       /**
        ...
        protected function getListQuery()
        {
          ...
          $query=  "select jls.department , jld.name domain , ".
                  " avg(jls.rating) rating,  count(*) chats ".
                  " from  #__livehelp_domains jld, #__livehelp_sessions jls ".
