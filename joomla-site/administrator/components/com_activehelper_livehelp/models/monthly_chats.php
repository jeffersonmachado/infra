...
class activehelper_livehelpModelMonthly_chats extends JModelList
{
	...
	protected function populateState($ordering = NULL, $direction = NULL)
	{
       ...
       /**
        ...
        protected function getListQuery()
        {
          ...
          $query= "SELECT CONCAT(jlu.firstname, ' ',jlu.lastname) name,  jld.name domain,  count(jls.id) as chats ".
                  ...
                  " and jls.id_user = jlu.id and " .
                  " jls.id_domain =jld.id_domain ".
                  " GROUP BY jls.id_domain, jlu.username , CONCAT(jlu.firstname, ' ',jlu.lastname) ".
                  " ORDER BY CONCAT(jlu.firstname, ' ',jlu.lastname)";   
