...
class activehelper_livehelpViewMonthly_chats extends JViewLegacy
{
	...
	{
		JToolBarHelper::title(JText::_('COM_ACTIVEHELPER_LIVEHELP_R_MONTHLY_CHATS'));
        JToolBarHelper::custom('reports.tocsv', 'publish', 'publish','COM_ACTIVEHELPER_LIVEHELP_B_TOCSV', false);   
