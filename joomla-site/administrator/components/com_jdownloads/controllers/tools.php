...
class jdownloadsControllertools extends jdownloadsController
{
    ...
    */
    ...
    {        
        ...
        $jlistConfig['user.can.download.file.when.zero.points'] = '0';
        ...
        $log[] = sprintf(JText::_('COM_JDOWNLOADS_UPDATE_CONFIG'), $sum_configs);
    ...
    */
    ...
    /**
    * Write the confirmation key in old config to start next time the 3.9 update process directly
    * Started from the 3.9 update process manually by the user himself
    */
    
    public function confirmUpdate39(){
        ...
        if ($canDo->get('edit.config')){
            ...
            $query = 'INSERT INTO '.$db->quoteName('#__jdownloads_config')." (setting_name, setting_value) VALUES ('confirm.update39', '1')";  
            $db->SetQuery($query);
            $db->execute();
            
            echo '<div class="alert alert-error"><b>jDownloads</b>:<br />'.JText::_('COM_JDOWNLOADS_CONFIRM_UPDATE_TO_39_HINT').'</div>';
