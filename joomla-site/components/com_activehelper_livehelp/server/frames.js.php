...
if (isset($_REQUEST['DIRECTION'])){
   $text_dir = (string) $_REQUEST['DIRECTION'];
}
...
//              alert('<?php echo $install_directory; ?>/refresher.php?LANGUAGE=<?php echo LANGUAGE_TYPE; ?>&DIRECTION=<?php echo( (int) $text_dir ); ?>&DOMAINID=<?php echo( (int) $domain_id ); ?>&URL=<?php echo urlencode( $URL ); ?>&lastMessageID=' + lastMessageID);
                top.displayFrame.displayRefreshFrame.location.href = '<?php echo $install_directory; ?>/refresher.php?DOMAINID=<?php echo( (int) $domain_id ); ?>&LANGUAGE=<?php echo LANGUAGE_TYPE; ?>&DIRECTION=<?php echo( (int) $text_dir ); ?>&URL=<?php echo urlencode( $URL ); ?>&lastMessageID=' + lastMessageID;
        }
}
...
function LoadMessages() {
        ...
        if (LiveHelpXMLHTTP) {
                ...
                var URL = '<?php echo $install_directory; ?>/refresher.php?LANGUAGE=<?php echo LANGUAGE_TYPE; ?>&DIRECTION=<?php echo( (int) $text_dir ); ?>&DOMAINID=<?php echo( (int) $domain_id ); ?>&JS=1&TYPING=' + currentlyTyping + '&INIT=' + initalisedChat + '&COOKIE=<?php echo($cookie_domain); ?>&TIME=' + time + '&URL=<?php echo urlencode( $URL ); ?>&lastMessageID=' + lastMessageID;
//              alert(URL);
