...
{
   $_REQUEST['DIRECTION'] = '1';
} else $_REQUEST['DIRECTION'] = htmlspecialchars( (string) $_REQUEST['DIRECTION'], ENT_QUOTES );
...
$result   = '0';
$text_dir = $_REQUEST['DIRECTION'];

//error_log("direction: ".$text_dir."\n", 3, "send.log");
  ...
  //error_log("Send:".$message."\n", 3, "../error.log");
   ...
   if (!$staff)
   {
      ...
      $query = "INSERT INTO " . $table_prefix . "messages ( `session`, `username`,".
               ...
               " '$operator_name', NOW(), '$message', $text_dir, $type, $id_domain, $operator_login_id)";
   ...
   else
   {
       ...
       $query = "INSERT INTO " . $table_prefix . "administration ( `user`, `username`, `operator_id` ,".
               " `datetime`, `message` , `align`, `status`) VALUES( '$to', '$operator_name', '$operator_login_id' , NOW(), '$message' , $text_dir , '1')";
